...
public class HelloSchedulerListener implements SchedulerListener {
    ...
    public void jobScheduled(Trigger trigger) {
        ...
        log.info("{} 完成部署", jobName);
    }

    @Override
    public void jobUnscheduled(TriggerKey triggerKey) {
        log.info("{} 完成卸载", triggerKey);
    }
    ...
    public void triggerPaused(TriggerKey triggerKey) {
        log.info("{} 正在被暂停", triggerKey);
    }

    @Override
    public void triggersPaused(String triggerGroup) {
        log.info("触发器组 {} 正在被暂停", triggerGroup);
    }
    ...
    public void jobResumed(JobKey jobKey) {
        log.info("{} 正在从暂停中恢复", jobKey);
    }

    @Override
    public void jobsResumed(String jobGroup) {
        log.info("工作任务组 {} 正在从暂停中恢复", jobGroup);
    }
